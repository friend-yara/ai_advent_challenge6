...
class Orchestrator:
    ...
    def _execute_document_search(self, arguments: dict) -> tuple[str, str, dict]:
        ...
        _WEAK_CONTEXT_MSG = (
            ...
            "Если пользователь просит прочитать файл "
            "или выполнить действие — используй доступные "
            "инструменты. Если это вопрос по документам — "
            "скажи что релевантной информации не найдено "
